...
# ============================================================
#
# ТИМЧАСОВО: додано st.write з сирою відповіддю API, щоб
# побачити реальні коди (DP) пристрою і зрозуміти, чому
# "switch" не знаходиться. Після діагностики цей рядок
# треба прибрати (позначено нижче коментарем DEBUG).
# ============================================================
...
def get_device_status(
    ...
    # --- DEBUG: прибрати цей рядок після діагностики ---
    st.write(
        f"DEBUG response ({device_id}):",
        response,
    )
    # ------------------------------------------------------
