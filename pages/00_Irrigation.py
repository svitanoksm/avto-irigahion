...
def load_data(spreadsheet_name, worksheet_name):
    ...
    if energy_col:
        df[energy_col] = df[energy_col].apply(
            convert_to_number
        )
    ...
    if water_col:
        df[water_col] = df[water_col].apply(
            convert_to_number
        )
...
# ============================================================
    ...
    if not modules_list or not module_col:
        ...
        st.warning(
            "Наразі не виявлено активних "
            "модулів у базі даних."
        )
    ...
    if power_col_name in df_filtered.columns:
        ...
        if not power_data.empty:
            ...
            st.info(
                ...
                "побудови тренду потужності."
            )

    else:

        st.info(
            "Стовпець потужності не знайдено."
        )
    ...
    if (
        ...
        if not en_df.empty:
            ...
            try:
                ...
                if not hourly_energy.empty:
                    ...
                    st.info(
                        "Недостатньо даних для "
                        "побудови погодинного "
                        "графіка електроенергії."
                    )
        ...
        st.info(
            "Стовпець показників лічильника "
            "електроенергії не знайдено."
        )
    ...
    if flow_col_name in df_filtered.columns:
        ...
        if not flow_data.empty:
            ...
            st.info(
                "Недостатньо даних для "
                "побудови тренду продуктивності."
            )

    else:

        st.info(
            "Стовпець продуктивності "
            "не знайдено."
        )
    ...
    if (
        ...
        if not wat_df.empty:
            ...
            st.info(
                "Недостатньо даних для "
                "побудови погодинного графіка води."
            )
...
# ============================================================
    ...
    st.title(
        f"🌳 Аналітика поливу однієї рослини: "
        f"{selected_module}"
    )
    ...
    def get_water_per_tree_for_year_dates(
        target_year,
        start_dt,
        end_dt,
    ):
    ...
    def get_water_per_tree_for_period(
        days_back_start,
        days_back_end,
    ):
