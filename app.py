...
                    st.info(
                        "Немає числових даних для побудови "
                        "графіка потужності."
                    )
...
                    # -------------------------------------------------
                    # ФІЛЬТР АНОМАЛЬНИХ ЗНАЧЕНЬ
                    # -------------------------------------------------
                    #
                    # 65899.81 — явно аномальне значення.
                    #
                    # Воно НЕ видаляється з df_filtered,
                    # тому залишається у детальній таблиці.
                    #
                    # Для графіка використовуємо тільки значення
                    # до 200 м³/год.
                    # -------------------------------------------------
...
                        # -------------------------------------------------
                        # ПРОСТА НАЗВА КОЛОНКИ ДЛЯ ALTAIR
                        # -------------------------------------------------
...
Повернув цей код. 
Допрацюй його так, щоб графік був одним стовпчатим графіком, на якому один стовпець буде показувати витрати електроенергії, а інший стовпець — витрати води. Електроенергія була червоним кольором, а вода — синім. 
